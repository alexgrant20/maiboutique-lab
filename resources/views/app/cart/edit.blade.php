...
<div class="d-flex justify-content-center align-items-center p-4 m-5" style="height: 68.7vh">
    <div class="card mb-3" style="max-width: 900px;">
        <div class="row g-0">
        <div class="col-md-4">
            <img src="{{$cartDetail->product->image}}" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-8">
            <div class="card-body">
                ...
                <form action="{{ route('cart.update', ['cartDetail'=>$cartDetail]) }}" method="POST" class="d-flex" role="qty">
                    @csrf
                    @method('patch')
