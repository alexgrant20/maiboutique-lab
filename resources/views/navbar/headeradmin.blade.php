<nav class="navbar navbar-expand-lg bg-black navbar-dark">
    <div class="container-fluid m-1">
      <a class="navbar-brand" href="{{ route('index') }}"><h3>MAI BOTIQUE</h3></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="d-flex">
            <a href="{{ route('product.create') }}"><button class="btn btn-primary m-1" style="font-size: 15px">Add Item</button></a>
        </div>
        <div class="d-flex">
